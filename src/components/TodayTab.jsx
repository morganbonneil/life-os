    ...
    <div>
      ...
      <div className="grid">
        ...
        <section>
          ...
          <div style={{ font: "700 12.5px/1.4 'Plus Jakarta Sans',system-ui,sans-serif", color: "var(--muted)", marginBottom: 10 }}>Little things that pop up — no due date, no obligation to do them today.</div>
